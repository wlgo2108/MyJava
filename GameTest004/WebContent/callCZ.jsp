...
<body>
	<div id="left">
		<form method="post" action="tcAction_cz.action" name="myForm">
			<p>
			...
			操作：<select name = "stat" onChange="changeStat()">
				...
				<option value = "3" selected>冲正</option>
			...
			冲正期号：<input type="text" name="issue" id="issue" value = "2017001">
			</p>
			<p id ="tsn_p" style="display:block">
			冲正流水号：<input type="text" name="tsn" id = "tsn" value = "1" >
			<p>
