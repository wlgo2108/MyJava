...
<body>
	<div id="left">
		<form method="post" action="tcAction_jk.action" name="myForm">
			<p>
			...
			操作：<select name = "stat" onChange="changeStat()">
				...
				<option value = "7"selected>银行缴款</option>
			</select>
			</p>
			<p id ="type_p" style="display:none">
			<input type="radio" name="type" value="0" checked>EXCEL&nbsp;<input type="radio" name="type" value="1">
			</p>
			<p id = "issue_p" style="display:none">
			期号：<input type="text" name="issue" id="issue" value = "2017001">
			</p>
			<p id ="tsn_p" style="display:none">
			流水号：<input type="text" name="tsn" id = "tsn" value = "1" >
			<p>
			<p id = "money_p" style="display:block">
			缴款金额：<input type="text" name="money" id = "money" value="0">
			</p>
			<p>
			认证码：<input type="text" name="station_cert" id = "station_cert" value = "0">
			</p>
			<p>
