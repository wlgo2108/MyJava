...
<body>
	<div id="left">
		<form method="post" action="tcAction_dj_d.action" name="myForm">
			<p>
			...
			操作：<select name = "stat" onChange="changeStat()">
				...
				<option value = "5"selected>多期兑奖</option>
			...
			兑奖期号：<input type="text" name="issue" id="issue" value = "2017001">
			</p>
			<p id ="tsn_p" style="display:block">
			兑奖流水号：<input type="text" name="tsn" id = "tsn" value = "1" >
			<p>
