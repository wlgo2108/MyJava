...
<body>
	<div id="left">
		<form method="post" action="tcAction_zx.action" name="myForm">
			<p>
			...
			注销期号：<input type="text" name="issue" id="issue" value = "2017001">
			</p>
			<p id ="tsn_p" style="display:block">
			注销流水号：<input type="text" name="tsn" id = "tsn" value = "1" >
			<p>
